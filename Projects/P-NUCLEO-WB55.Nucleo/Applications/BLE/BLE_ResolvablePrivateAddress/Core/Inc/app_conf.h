...
#define CFG_BLE_ADDRESS_TYPE              RANDOM_ADDR   //[JT]  /**< Bluetooth address types defined in ble_legacy.h */
...
#define CFG_SC_SUPPORT                 CFG_SECURE_MANDATORY  //CFG_SECURE_OPTIONAL
...
#define  RADIO_ACTIVITY_EVENT   0 //1      //[JT]    /* 1 for OOB Demo */
...
typedef enum
{
    ...
    CFG_TASK_PAIRING_REQ_ID,           //[JT]
    CFG_TASK_ADD_RESOLVING_LIST_ID,    //[JT]    
    CFG_TASK_READ_RPA_ID,              //[JT]        
